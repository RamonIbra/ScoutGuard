-Project video: https://www.youtube.com/watch?v=RKF0b1V8nj0&ab_channel=RamonIbrahim
...
Performance Analytics & Regression Modelling
...
## Notera angående Git-historiken

Git-historiken i detta repo kan se ovanlig ut på grund av initiala problem med oönskade filer. Ett försök att lösa detta med mappflytt och `force push` var inte optimalt.

För stabilare arbete bytte jag till ThinLinc och fortsatte utvecklingen i en ny `master`-branch. Den gamla `main`-branchen finns kvar med tidiga commits dock inte allt då en liten del försvann i processen.
